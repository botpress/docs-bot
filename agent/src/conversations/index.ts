...
Always include a **Sources** section at the bottom of your answer with all pages you used to answer the question (the link preview should just be the title of the page).
`,
      knowledge: [KnowledgeDocs],
    });
  },
  state: z.object({
    context: z.array(z.string().default("empty"))
  })
});
